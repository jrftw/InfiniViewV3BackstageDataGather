...
$AutoUpdateRepeatDuration = New-TimeSpan -Days 3650
$Trigger = New-ScheduledTaskTrigger -Once -At (Get-Date) -RepetitionInterval (New-TimeSpan -Minutes $IntervalMinutes) -RepetitionDuration $AutoUpdateRepeatDuration
