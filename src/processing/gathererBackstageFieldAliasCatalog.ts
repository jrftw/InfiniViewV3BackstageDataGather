...
export const GATHERER_BACKSTAGE_CREATOR_DATA_FIELD_ALIASES: GathererBackstageFieldAliasDefinition[] = [
  {
    ...
    headerExcludePatterns: [/l30d/, /last30/, /last_30/, /last_month/, /fan/, /match/, /multi/, /guest/, /prior/, /bonus/, /incentive/],
    valueKind: "diamonds",
  },
  {
    ...
    headerExcludePatterns: [/l30d/, /last30/, /last_30/, /last_month/, /prior/],
  ...
  {
    systemFieldName: "prior_month_diamonds",
    parseTargetRowKey: "diamonds_last_month",
    backstageRowKeyAliases: [
      "diamonds_last_month",
      "diamondslastmonth",
      "diamonds_in_last_month",
      "last_month_diamonds",
    ],
    headerIncludePatterns: [/diamond.*last.*month/, /last.*month.*diamond/],
    headerExcludePatterns: [/l30d/, /last30/, /last_30/, /fan/, /match/, /multi/, /guest/],
    valueKind: "diamonds",
  },
  {
    systemFieldName: "prior_month_hours",
    parseTargetRowKey: "live_duration_hours_last_month",
    backstageRowKeyAliases: [
      "live_duration_hours_last_month",
      "livedurationhourslastmonth",
      "live_duration_last_month",
      "last_month_live_duration_hours",
    ],
    headerIncludePatterns: [/live.*duration.*last.*month/, /last.*month.*live.*duration/, /last.*month.*hour/],
    headerExcludePatterns: [/l30d/, /last30/, /last_30/],
    valueKind: "duration_hours",
  },
  {
    systemFieldName: "prior_month_valid_days",
    parseTargetRowKey: "valid_go_live_days_last_month",
    backstageRowKeyAliases: [
      "valid_go_live_days_last_month",
      "validgolivedayslastmonth",
      "valid_live_days_last_month",
      "last_month_valid_go_live_days",
    ],
    headerIncludePatterns: [/valid.*live.*day.*last.*month/, /last.*month.*valid.*day/],
    headerExcludePatterns: [/l30d/, /last30/, /last_30/],
    valueKind: "days",
  },
  {
